...
func _ready():
    if not hex_borders_checkbox or not edge_scrolling_checkbox or not back_button or not tooltip_delay_slider or not tooltip_delay_value_label or not extended_tooltip_delay_slider or not extended_tooltip_delay_value_label:
